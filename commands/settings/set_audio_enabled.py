...
from commands.settings.schemas import SetAudioEnabledRequest, ParticipantUpdatedResponse
...
@register_handler(
    "set_audio_enabled",
    request_model=SetAudioEnabledRequest,
    responses={
        "participant_updated": (
    ...
    description="Включить или выключить отправку аудио. Состояние рассылается всем.",
    group="settings"
)
