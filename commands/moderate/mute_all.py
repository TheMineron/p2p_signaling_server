from commands.moderate.schemas import ForceMuteResponse, AllMutedResponse, MuteAllRequest
...
@register_handler(
    "mute_all",
    request_model=MuteAllRequest,
    responses={
        "force_mute": (
                ForceMuteResponse,
                "Отправляется каждому участнику (кроме модератора)"
        ),
        "all_muted": (
                AllMutedResponse,
    ...
    description="Отключение микрофонов у всех участников, кроме модератора.",
    group="moderate"
)
