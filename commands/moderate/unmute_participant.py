from commands.moderate.schemas import UnmuteParticipantRequest, ForceUnmuteResponse, \
...
@register_handler(
    "unmute_participant",
    request_model=UnmuteParticipantRequest,
    responses={
        "force_unmute": (
                ForceUnmuteResponse,
    ...
    description="Включение микрофона у конкретного участника (только для модератора).",
    group="moderate"
)
